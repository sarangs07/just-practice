        ...
        public function sa_countdown_plugin_options()
        {
            ...
            echo 							'</div>
                                            ...
                                            <div div class="col-md-6">
                                                <h3>How to add SA - Countdown to your website.</h3>
                                                <p>Follow below step by step instructions to add the plugin</p>
                                                <ul>
                                                    <li>Give/Enter the title for your plugin</li>
                                                    <li>Select/Enter the target date</li>
                                                    <li>Save the changes</li>
                                                    <li>Copy - Paste this shortcode <strong>[sa_countdown]</strong> and place where you want to display the countdown</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
